...
#define TMC2130_SG_THRS_X       3     // stallguard sensitivity for X axis (3)
#define TMC2130_SG_THRS_Y       3     // stallguard sensitivity for Y axis (3)
